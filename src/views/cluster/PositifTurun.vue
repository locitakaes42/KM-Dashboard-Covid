<template>
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          ...
          <small>Kasus Positif Covid Menurun</small>
        </h1>
      </section>
          ...
          <div class="col-md-10 mb-4">
            <div class="card">
              <div class="card-header text-center">
                <h3 class="card-title">Clustering Visualization for Kasus Positif Covid Menurun</h3>
              </div>
  ...
  export default {
    name: "ClusteringKasusPositifTurun",
    data() {
      return {
        imageUrl: '', // Image URL
